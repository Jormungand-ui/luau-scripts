...
local function creerGUI()
    ...
    lblVitesse.Size = UDim2.new(1,-16,0,18) lblVitesse.Position = UDim2.new(0,8,0,128)
    ...
    piste.Size = UDim2.new(1,-24,0,20) piste.Position = UDim2.new(0,12,0,152)
    ...
    lblCompteur.Size = UDim2.new(1,-16,0,20) lblCompteur.Position = UDim2.new(0,8,0,182)
    ...
    lblProche.Size = UDim2.new(1,-16,0,18) lblProche.Position = UDim2.new(0,8,0,207)
